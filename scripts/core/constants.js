...
export const SETTING_SORT_MODE = "sortMode";
export const SETTING_TAG_HIERARCHY = "tagHierarchy";

// Keybinding IDs
export const KEYBIND_PLAY_FIRST = "playFirstMatchingSound";
export const KEYBIND_PLAY_LAST = "playLastMatchingSound";
export const KEYBIND_PLAY_RANDOM = "playRandomMatchingSound";
...
export function log(...args) {
    if (DEBUG) console.log("Audio Tagger |", ...args);
}
